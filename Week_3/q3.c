// Read a string of length evenly divisible by N. Using N processes, find the number of non vowels in the string. 
// In root process print number of non vowels found by each process and print total non vowels. 
